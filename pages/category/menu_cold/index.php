...
<body onLoad='init()'>
    ...
    <div id="category_body">
        ...
        <h1>Cold Drinks</h1>
            <h3>Frappes</h3>
            <hr />
            <div id="frappe_con" class="item_container">
            ...
            <h3>Iced Coffees</h3>
            <hr />
            <div id="iced_coffee_con" class="item_container">
                <!-- <div class="item_widget">
                    <img src="lib/images/static/menu_coffee.png" draggable="false" />
                    <span>Drink one</span>
                </div> -->
            ...
            <h3>Slushies</h3>
            <hr />
            <div id="slushie_con" class="item_container">
                <!-- <div class="item_widget">
                    <img src="lib/images/static/menu_coffee.png" draggable="false" />
                    <span>Drink one</span>
                </div> -->
            ...
            <h3>Refrigirated Drinks</h3>
            <hr />
            <div id="refrigirated_con" class="item_container">
                <!-- <div class="item_widget">
                    <img src="lib/images/static/menu_coffee.png" draggable="false" />
                    <span>Drink one</span>
                </div> -->
